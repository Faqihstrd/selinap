                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="authorModalLabel">Tentang SELINAP</h5>
                            ...
                            <div class="modal-body">
                                <p>
                                    Aplikasi <b>SELINAP</b> dikembangkan dengan <i style="color:#FF80AB" ></i> oleh
                                    <a href="https://www.nice.web.id" target="_blank">M Faqih</a> dan tim <a href="https://globalWeb.id/" target="_blank">globalWeb.id</a>.
                                </p>
                            </div>
