...
class PrintBt extends StatefulWidget {
  ...
  const PrintBt(this.namaPelajar, {super.key});
                      ...
                      OutlinedButton(
                        ...
                        onPressed: _connected
                            ? () async {
                                ...
                                for (var i = 0;
                                    i < widget.namaPelajar.hashCode;
                                    i++) {
                                  list.add(
                                    LineText(
                                      type: LineText.TYPE_TEXT,
                                      content: widget.namaPelajar,
                                      weight: 0,
                                  ...
                                  list.add(
                                    LineText(
                                      type: LineText.TYPE_TEXT,
                                      content:
                                          "${f.format(this.widget.namaPelajar)} x ${this.widget.namaPelajar}",
                                      align: LineText.ALIGN_LEFT,
                                      linefeed: 1,
                                    ),
                                  );
